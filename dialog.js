...
(function($) {
    $.showDialog = function(options) {
        ...
        function stayCenter(dialogBox){
            var top = ($(window).height() - dialogBox.height()) / 3;
...
//                centerDialogBox();
        ...
        function bindCloseEventHandler() {
            ...
            $('#dialog-close-button, .close-dialog').live('click', function() {
...
(function($) {
    $.confirm = function(options) {
        ...
        var content = '<img src="/static/dialog/dialog-warning.gif"><p class="confirm-content">' + settings.message + '</p><fieldset><button id="confirm-ok">OK</button><button id="confirm-cancel">Cancel</button></fieldset>';
        $.showDialog({
            content: content,
            model: true,
            width: '300px'
